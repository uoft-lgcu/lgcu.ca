...
{% assign length = site.data.committees.treasurer.size %}{% for member in site.data.committees.treasurer %}{{ member | lingsite }}{% assign length = length | minus: 1 %}{% if length != 0 %}, {% endif %}{% endfor %}
